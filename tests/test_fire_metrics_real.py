...
@pytest.mark.real_data
def test_real_consensus_ensemble_smoke(real_hourly_and_df):
    """Linha E: voto 2/3 entre twin, combined_persistence e residual espacial."""
    from src.unsupervised_fire_goes import detect_consensus_ensemble
