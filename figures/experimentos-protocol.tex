...
\end{subfigure}
\caption{Wildfire hotspot temporal patterns in Ceará (INPE BDQueimadas, 2024--2025).}
...
Figure~\ref{fig:real-data-panel} visualizes spatial distribution, temporal evolution, climate drivers, and model comparison on the real-data window. Municipal-level counts are reported in Appendix~\ref{app:exp-b} (Figure~\ref{fig:municipios-appendix}).
